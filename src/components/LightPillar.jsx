...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    const qualitySettings = {
      low: { iterations: 20, waveIterations: 1, pixelRatio: 0.4, precision: 'mediump', stepMultiplier: 1.8 },
      medium: { iterations: 32, waveIterations: 2, pixelRatio: 0.5, precision: 'mediump', stepMultiplier: 1.3 },
      high: {
        iterations: 56,
        waveIterations: 3,
